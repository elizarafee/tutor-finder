        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-9">
            <ul class="list-unstyled float-left">
              @if(auth()->user()->type == 1)
              <li class="text-info"><a href="{{url('/students/'.$student->id)}}">{{$student->first_name.' '.$student->last_name}}</a></li>
              @endif
              ...
              <li class="text-muted"><span class="text-dark">Student bio <small>({{date('Y') - $student->year_of_birth}}
                    year old
