 ...
 <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#reject-profile-modal">
   Reject request
 </button>
     ...
     <div class="modal-content">
       <form method="POST" action="{{ url('/connects/'.$student->user_id.'/reject') }}">
         ...
         <div class="modal-body">
           <p class="text-left">
             Are you sure to reject request from {{ $student->user_first_name.' '.$student->user_last_name}}?
           </p>
         </div>
